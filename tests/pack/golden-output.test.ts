...
function shouldSkipManifestPath(rel: string): string | null {
  ...
  // Not regenerated by pack yet: need dict-revised-translated / category sources.
  if (base === 'index.json' || base === 'xref.json') {
    return 'index/xref not produced by current pack pipeline';
  }
